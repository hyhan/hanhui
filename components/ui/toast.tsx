...
import { Loader2, CircleCheck, CircleAlert, Info, TriangleAlert } from 'lucide-react'
...
export const showSuccessToast = (msg: Message, opts?: ToastOptions) => {
  toast(msg, {
    ...opts,
    icon: (
      <CircleCheck className="text-xl text-green-500 dark:text-green-600" />
    ),
    className:
...
export const showInfoToast = (msg: Message, opts?: ToastOptions) => {
  toast(msg, {
    ...opts,
    icon: (
      <Info className="text-xl text-blue-500 dark:text-blue-600" />
    ),
    className:
...
export const showWarningToast = (msg: Message, opts?: ToastOptions) => {
  toast(msg, {
    ...opts,
    icon: (
      <TriangleAlert className="text-xl text-yellow-500 dark:text-yellow-600" />
    ),
    className:
...
export const showErrorToast = (msg: Message, opts?: ToastOptions) => {
  toast(msg, {
    ...opts,
    icon: (
      <CircleAlert className="text-xl text-red-500 dark:text-red-600" />
    ),
    className:
...
export const showLoadingToast = (msg: Message, opts?: ToastOptions) => {
  return toast(msg, {
    ...opts,
    icon: <Loader2 className="text-xl animate-spin" />,
    className:
